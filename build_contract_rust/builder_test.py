...
def test_build_project():
    ...
    actual_source = outcome.get_entry("adder").artifacts.src_package.read()
    actual_wat = outcome.get_entry("adder").artifacts.text.read()
    ...
    assert actual_source == read_binary_file(Path("./testdata/expected/adder-1.2.3.source.json"))
    assert actual_wat == read_binary_file(Path("./testdata/expected/adder.wat"))

    actual_source = outcome.get_entry("empty").artifacts.src_package.read()
    actual_wat = outcome.get_entry("empty").artifacts.text.read()
    ...
    assert actual_source == read_binary_file(Path("./testdata/expected/empty-4.5.6.source.json"))
    assert actual_wat == read_binary_file(Path("./testdata/expected/empty.wat"))
